#Unix
setwd(dir = "/home/mael/Documents/M2BI/AIAO/AIAO_floobits/kaggle/projet_perso/stanford-covid-vaccine")
#Mac
...
#Import des données
data_arn = list()
data_arn$test = lapply(readLines("test.json"), fromJSON)
data_arn$train = lapply(readLines("train.json"), fromJSON)
